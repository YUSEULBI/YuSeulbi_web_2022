...
public class 과제1_연산자문제 {
	...
	public static void main(String[] args) {
		...
		// 21번 문제
		int 첫번째정수 = scanner.nextInt();
		int 두번째정수 = scanner.nextInt();
		int 세번째정수 = scanner.nextInt();
		int 가장큰수 = (첫번째정수 > 두번째정수 && 첫번째정수 > 세번째정수) ? 첫번째정수 :
			(두번째정수 > 첫번째정수 && 두번째정수 > 세번째정수) ? 두번째정수 : 세번째정수;
		System.out.println( "21번. 세 정수중 가장 큰 수 : " + 가장큰수);
		
		// 22번 문제
		// 가위 0 / 바위 1 / 보 2
		// 플레이어1 / 플레이어2
		short 플레이어1 = scanner.nextShort();
		short 플레이어2 = scanner.nextShort();
		...
		(플레이어1 == 2 && 플레이어2 == 1 ) ? "플레이어1 승리" :
			...
			(플레이어1 == 1 && 플레이어2 == 2) ? "플레이어2 승리" :
				(플레이어1 == 0 && 플레이어2 == 0) ||
				(플레이어1 == 1 && 플레이어2 == 1) ||
				(플레이어1 == 2 && 플레이어2 == 2) ? "무승부" : "무승부" ;
		
		System.out.println("22번 문제 : " + 가위바위보결과 );
	}
