...
if(10 > 20 ); console.log('[참3] 10이 더 크다 ') // X 세미콜론으로 끊겨서 출력됨
...
//문제3번
let value2 = Number( prompt('점수 입력') )
if (value2>=90){console.log('A등급');}
else if (value2>=80){console.log('B등급');} 
else if (value2>=70){console.log('C등급');}
else {console.log('탈락')}
